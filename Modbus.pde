...
void DoModbus() {
  ...
  //          break;
    ...
    regs[MB_FUELSWITCHLEVEL] = (int)FuelSwitchLevel; //FuelSwitchLevel[FuelSwitchLevelName]       
    regs[MB_P_RATIO_FILTER_STATE] = int(pRatioFilterHigh);  
    ...
    regs[MB_LAMBDA_IN] = int(10*lambda_input);
    regs[MB_LAMBDA_OUT] = (int)lambda_output;
